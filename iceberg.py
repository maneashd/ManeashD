...
from avro.schema import make_avsc_object, RecordSchema, ArraySchema
import copy

# Input and output file paths
input_file = "schema.json"
output_file = "schema_with_ids.json"  # Changed to .json
    ...
    if isinstance(avro_schema, RecordSchema):
        ...
        for field in avro_schema.fields:
            ...
            if isinstance(new_field.type, RecordSchema):
                ...
                new_field.type.props['element-id'] = idcomputed_counter
                id_counter += 1
...
# Add field IDs and element IDs
modified_avro_schema, _ = addGreedy_field_ids(avro_schema)
